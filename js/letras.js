...
const resolver = () => { 
    ...
    const typed = new Typed('.texto', {
        strings: [
            "yo eligiria ser Tu elixir de Felicidad<br>un remedio infalible contra tristezas, miedos<br>y garantía de una sonrisa constante.<br><span class='fw-bold'>i &lt; 3 u</span> <br><span class='fw-bold'>Esmélida</span>",
        ],
        typeSpeed: 65,
        showCursor: false,
        shuffle: false,
...
/*"Si fueras una medicina, elegiría ser tu 'Elixir de Felicidad',
 un remedio infalible contra tristezas, miedos 
 y garantía de una sonrisa constante. ¿Te unes a mi tratamiento para una vida siempre feliz?" 😄💖*/
const bajar = (i) => {
